...
// or mainForm.elements.nameRadio
...
let selectedOptions = Array.form(mainFormSelect.options)
...
const mainForm = document.form.main;
const mainFormInput = mainForm.nameInput;
...
mainForm.addEventListener("focusin", function(){
...
mainFormFile.addEventListener('change', function(){
...
mainForm.addEventListener("sumbit", function(event){
